<%@ Page Title="Terms & Conditions" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Terms.aspx.cs" Inherits="ShrineFoxCom.Terms" %>
...
<br>
<br><p>Welcome to ShrineFox.com!</p>

<p>These terms and conditions outline the rules and regulations for the use of ShrineFox.com's Website, 
    located at https://shrinefox.com.</p>

<p>By accessing this website we assume you accept these terms and conditions. Do not continue to use ShrineFox.com 
...
<p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and all 
    ...
    in the singular, plural, capitalization and/or he/she or they, are taken as interchangeable and therefore as 
    referring to same.</p>

<h3><strong>Cookies</strong></h3>

<p>We employ the use of cookies. By accessing ShrineFox.com, you agreed to use cookies in agreement with the 
    ShrineFox.com's Privacy Policy. </p>
...
<p>You must not:</p>
<ul>
    <li>Republish material from ShrineFox.com</li>
    <li>Sell, rent or sub-license material from ShrineFox.com</li>
    <li>Reproduce, duplicate or copy material from ShrineFox.com</li>
    <li>Redistribute content from ShrineFox.com</li>
</ul>

<p>This Agreement shall begin on the date hereof. Our Terms and Conditions were created with the help of the 
    <a href="https://www.privacypolicies.com/blog/sample-terms-conditions-template/">Terms And Conditions Template</a>.</p>
...
<p>ShrineFox.com reserves the right to monitor all Comments and to remove any Comments which can be considered 
...
<p>You hereby grant ShrineFox.com a non-exclusive license to use, reproduce, edit and authorize others to use, 
...
<p>We will approve link requests from these organizations if we decide that: (a) the link would not make us 
    ...
    ShrineFox.com; and (d) the link is in the context of general resource information.</p>
...
<p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you 
    must inform us by sending an e-mail to ShrineFox.com. Please include your name, your organization name, contact 
...
<p>No use of ShrineFox.com's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
...
<p>If you find any link on our Website that is offensive for any reason, you are free to 
    <a href="mailto:ryan@shrinefox.com">contact and inform us</a> 
